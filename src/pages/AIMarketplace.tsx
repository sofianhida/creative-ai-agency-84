...
import { Search, Filter, ShoppingCart, Star, ChevronDown, Info, Calendar } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 pt-24">
        <div className="text-center mb-10">
          ...
          {/* Coming Soon Banner */}
          <div className="dashboard-banner mt-8 bg-purple/10 p-4 rounded-lg">
            <div className="flex items-center justify-center gap-2">
              <Info size={20} className="text-purple" />
              <p className="text-purple font-medium">Our full marketplace is coming soon! Check out our preview below.</p>
            </div>
          </div>
          
          <div className="flex justify-center mt-4 gap-4">
            <button 
              className={`px-4 py-2 rounded-full transition ${!comingSoonMode ? 'bg-purple text-white' : 'bg-gray-100 hover:bg-gray-200'}`}
              onClick={() => setComingSoonMode(false)}
            >
              Preview Marketplace
            </button>
            <Link
              to="/dashboard"
              className={`px-4 py-2 rounded-full transition ${comingSoonMode ? 'bg-purple text-white' : 'bg-gray-100 hover:bg-gray-200'}`}
              onClick={() => setComingSoonMode(true)}
            >
        ...
        {comingSoonMode ? (
          <div className="dashboard-coming-soon">
            ...
            <h2>AI Marketplace Coming Soon</h2>
            <p>
              We're building a powerful AI marketplace for you to discover, purchase, and integrate
              cutting-edge AI solutions for your business needs. Stay tuned for our official launch!
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-8">
              <div className="bg-white rounded-xl p-5 shadow-sm border border-purple/10 hover:shadow-md transition hover:border-purple/20">
                <ShoppingCart size={24} className="text-purple mb-3" />
                <h3 className="font-semibold mb-1">Wide Selection of AI Solutions</h3>
                <p className="text-sm text-muted-foreground">From chatbots to analytics tools</p>
              </div>
              
              <div className="bg-white rounded-xl p-5 shadow-sm border border-purple/10 hover:shadow-md transition hover:border-purple/20">
                <Star size={24} className="text-purple mb-3" />
                <h3 className="font-semibold mb-1">Premium AI Services</h3>
                <p className="text-sm text-muted-foreground">High-quality AI solutions for businesses</p>
              </div>
              
              <div className="bg-white rounded-xl p-5 shadow-sm border border-purple/10 hover:shadow-md transition hover:border-purple/20">
                <Filter size={24} className="text-purple mb-3" />
            ...
            <div className="mt-8">
              <button 
                className="btn-primary inline-flex items-center py-2.5 px-6"
                onClick={() => setComingSoonMode(false)}
              >
                Preview Marketplace
              </button>
